...
const Checkout = () => {
  ...
  const isButtonDisabled = paymentMethod === "card" && (!cardName || !email);
  ...
  return (
    <GestureHandlerRootView className="flex-1 bg-['#fff']">
      ...
      <ScrollView className="flex-1 px-4 mb-6">
        {/* Order Summary */}
        <Text className="text-base text-xl font-bold mt-4 mb-2">
          Order Summary
        </Text>
        ...
        {cart.map((item: any, index: number) => (
          <View
            key={index}
            className="flex-row justify-between items-start mt-4 mb-3"
          >
        ...
        <View className="py-4 border-b border-gray-200">
          <Text className="text-base text-lg font-semibold mb-3">
            Payment Method
          </Text>
        ...
        {paymentMethod === "card" && (
          <View className="mb-4">
            ...
            <View className="mb-3">
              <Text className="text-xsm font-semibold mb-1">Name on card</Text>
              <TextInput
            ...
            <View className="mb-3">
              <Text className="text-xsm font-semibold mb-1">Email</Text>
              <TextInput
                className="border py-4 px-4 border-gray-400 rounded-lg"
      ...
      <View className="px-4 pb-5">
        <TouchableOpacity
          className="py-4 rounded-lg mb-4 items-center"
          disabled={isButtonDisabled}
          style={{
            backgroundColor: isButtonDisabled ? "#D3D3D3" : colors.primary,
          }}
          onPress={() => {
            // const transactionId =
            //   "TXN" + Math.floor(100000 + Math.random() * 900000); // 6-digit random
            // const now = new Date();
