...
const categoriesData = [
  {
    ...
    icon: require("../../assets/products/1.png"),
    bg: "#EAF4FF",
  },
  {
    name: "Meat & Poultry",
    desc: "Fresh meat cuts",
    icon: require("../../assets/products/2.png"),
    bg: "#FFECEC",
  },
  {
    name: "Seafood",
    desc: "Fresh fish & seafood",
    icon: require("../../assets/products/3.png"),
    bg: "#E6FAF8",
  },
  {
    name: "Bakery",
    desc: "Fresh baked goods",
    icon: require("../../assets/products/4.png"),
    bg: "#FFF5E0",
  },
  {
    name: "Pantry Staples",
    desc: "Essential groceries",
    icon: require("../../assets/products/5.png"),
    bg: "#FFF3D9",
  },
  {
    name: "Beverages",
    desc: "Drinks & juices",
    icon: require("../../assets/products/6.png"),
    bg: "#F6F0FF",
  },
];
