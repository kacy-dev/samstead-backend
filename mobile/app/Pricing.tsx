...
const Pricing = () => {
  return (
    <ScrollView className="flex-1 bg-white">
      ...
      {/* Premium Membership */}
      <View
        className="bg-green-100 border border-green-600 mx-4 rounded-xl mt-4"
        style={{ height: 425 }}
      >
        <View
        ...
        >
          ...
          <Text className="text-2xl font-bold text-white mt-2">
            ₦1,000 <Text className="text-sm font-semibold">/month</Text>
          </Text>
        ...
        <View className="space-y-2 mb-2">
          {[
            ...
            <Text key={index} className="text-gray-700 font-semibold px-4 mt-6">
              <Entypo name="check" color={colors.primary} size={18} /> {item}
            </Text>
          ))}
        </View>
      ...
      <View
        className="bg-purple-100 border border-purple-700 mx-4 rounded-xl mt-4 mb-10"
        style={{ height: 450 }}
      >
        <View
        ...
        >
          ...
          <Text className="text-2xl font-bold text-white mt-2">
            ₦3,000 <Text className="text-sm font-semibold">/month</Text>
          </Text>
          <Text className="text-sm font-bold text-white mb-3">
            or ₦30,000/year
          </Text>
        ...
        <View className="space-y-2 mb-2">
          {[
            ...
            <Text key={index} className="text-gray-700 font-semibold px-4 mt-6">
              <Entypo name="check" color={"purple"} size={18} /> {item}
            </Text>
          ))}
        </View>
